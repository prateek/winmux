...
public enum FormatVar: Equatable {
    ...
    public enum MonitorFormatVar: String, Equatable, CaseIterable {
        ...
        case monitorZoneAvailabilitySetId = "monitor-zone-availability-set-id"
        ...
        case monitorZoneRuntimeWidthOverride = "monitor-zone-runtime-width-override"
        case monitorZoneRuntimeWidthOverrideState = "monitor-zone-runtime-width-override-state"
        case monitorZoneLeft = "monitor-zone-left"
        case monitorZonePixelWidth = "monitor-zone-pixel-width"
