...
public enum FormatVar: Equatable {
    ...
    public enum MonitorFormatVar: String, Equatable, CaseIterable {
        ...
        case monitorIsZone = "monitor-is-column"
        case monitorColumnLayoutId = "column-layout-id"
        case monitorColumnAvailabilitySetId = "column-availability-set-id"
        case monitorColumnId = "column-id"
        case monitorColumnName = "column-name"
        case monitorColumnStyleId = "column-style-id"
        case monitorColumnStyleColor = "column-color"
        case monitorColumnEnabled = "column-enabled"
        case monitorColumnConfiguredWidth = "column-configured-width"
        case monitorColumnEffectiveWidth = "column-effective-width"
        case monitorColumnRuntimeWidthOverride = "column-runtime-width-override"
        case monitorColumnRuntimeWidthOverrideState = "column-runtime-width-override-state"
        case monitorColumnLeft = "column-left"
        case monitorColumnPixelWidth = "column-pixel-width"
